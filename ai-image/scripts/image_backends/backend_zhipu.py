...
# GLM-Image requires each dimension to be 512–2048 and a multiple of 32.
ASPECT_RATIO_SIZE_MAP = {
    "512px": {
        ...
        "4:5": "1024x1280",
        "5:4": "1280x1024",
        "9:16": "576x1024",    # was 720x1440 (720 not multiple of 32)
        "16:9": "1024x576",    # was 1440x720
        "21:9": "1536x640",
    },
    "1K": {
        "1:1": "1280x1280",
        "2:3": "960x1440",
        "3:2": "1440x960",
        "3:4": "1152x1536",    # was 1024x1365 (1365 not multiple of 32)
        "4:3": "1536x1152",    # was 1365x1024
        "4:5": "1024x1280",
        "5:4": "1280x1024",
        "9:16": "768x1344",
        "16:9": "1344x768",
    ...
    "2K": {
        ...
        "4:5": "1280x1600",
        "5:4": "1600x1280",
        "9:16": "1152x2048",   # was 720x1440
        "16:9": "2048x1152",   # was 1440x720
        "21:9": "1792x768",
    },
    "4K": {
        "1:1": "2048x2048",    # GLM-Image caps at 2048 per side; 4K tier reuses max
        "2:3": "1344x2016",
        "3:2": "2016x1344",
        "3:4": "1536x2048",
        "4:3": "2048x1536",
