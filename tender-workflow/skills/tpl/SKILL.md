...
```bash
python3 tools/tw_config.py get tpl default_template
python3 tools/tw_config.py get tpl default_level
```
...
```bash
python3 tools/docx_encoding_check.py --fix <output.docx> --max-retries 3
```
