...
Task tool (writer):
  ...
  prompt: |
    ...
    **Skill / mcp__* / WebFetch / WebSearch 等需审批工具，未在主 session
    ...
    1. **删填充短语**：去开场白与强调拐杖词（"值得注意的是" / "为了实现这一目标" / "在这个时间点" / "由于……的事实"）
    2. **打破公式结构**：避免二元对比、戏剧性"挑战与展望"段、强行三段式（凡可二项或四项更准确者不凑三项）
    3. **变化节奏**：句长适度变化，避免连续 3 句以上同长度；段落结尾方式多样化
    4. **信任专业读者**：直接陈述事实，跳过软化与手把手引导（专业评标读者已具备领域常识）
    5. **删除金句**：删除可被引用的修辞性结论句（"未来看起来光明" / "开启新征程" / "持续追求卓越"）

    **句式红线（全禁）**：

    - 否定式排比："不仅……而且……" / "这不仅仅是……而是……"
    - 句末 -ing 肤浅分析："……反映了……" / "……展示了……" / "……为……做出贡献" / "……标志着……"
    - 破折号代替逗号 / 句号
    - 内联标题垂直列表（`**XX：** 解释段` 形式 → 改为正常段落或表格）
    - 模糊归因（"专家认为" / "行业报告显示" / "一些观察者指出"无具体来源）
    - 公式化"挑战与未来展望"段
    - 通用积极结论（"未来光明" / "激动人心" / "开启新征程"）

    **AI 词汇黑名单（硬禁，正文严禁使用）**：

    此外 / 织锦 / 格局（抽象）/ 不可磨灭的印记 / 深深植根于 / 标志着 /
    见证了 / 深入探讨 / 持久的（修饰抽象）/ 开创性的（修饰非首创）/
    充满活力的 / 令人叹为观止的 / 必游之地 / 独一无二 / 颠覆性 /
    业界领先（无数据支撑时）

    **AI 词汇软约束**：

    "至关重要 / 关键 / 核心 / 重要 / 凸显 / 强调 / 彰显 / 全面 / 充分 /
    完善 / 丰富 / 高效"等同段不超过 2 次，且每次出现必须有数据 / 案例 /
    量化指标支撑。
