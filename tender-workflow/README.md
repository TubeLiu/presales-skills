...
│   │       ├── ai_image_generator.py  # AI 图片生成（火山方舟/阿里云/Gemini 三 API）
│   │       └── drawio_generator.py    # draw.io 图表生成工具
│   │
│   └── twc/                    # ✅ 配置管理
│       └── SKILL.md
│
...
/twc models --refresh    # 联网搜索最新模型并更新本地注册表
...
**配置工具**：`tools/tw_config.py`（支持 CLI 调用和 Python import 两种方式）
