...
PPT Master is a plugin in the [presales-skills](https://github.com/Alauda-io/skills) marketplace that converts multi-source documents (PDF / DOCX / URL / Markdown) into **natively editable PPTX** — real PowerPoint shapes, text boxes, and charts, not images.
