...
| `alauda` | Brand | Enterprise solutions, product introductions, technical architecture | Alauda Blue `#3BAEE3` | Modern tech consulting, structured, clean |
...
| `alauda` | Alauda (灵雀云) cloud-native tech style, modern consulting, clean and structured |
