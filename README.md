...
| 组件 | 当前版本 | 说明 |
|---|---|---|
| `marketplace.metadata.version` | `0.1.15` | 客户端 `/plugin marketplace update` 的触发信号 |
| `drawio` | `0.1.11` | 共享 plugin |
| `ai-image` | `0.1.9` | 共享 plugin |
| `anythingllm-mcp` | `0.1.2` | 可选 MCP plugin |
| `web-access` | `0.1.1` | 可选共享 plugin（从 solution-master 0.1.5 抽出，0.1.0 首发） |
| `solution-master` | `0.1.7` | 主 plugin |
| `ppt-master` | `0.2.0` | 主 plugin（minor bump：README 图变 GitHub Release 网络依赖，破坏性） |
| `tender-workflow` | `0.1.7` | 主 plugin |
